...
public class Post_Video {
    ...
    public Post_Video(Long id, String idperson, String texto, String idimagem, String email, String tipo, String hora, String hastags, String local, String description) {
        this.id = id;
