...
public class Post_Reel {
    ...
    public Post_Reel(Long id, String idperson, String texto, String idimagem, String email, String tipo, String hora, String hastags, String local, String description) {
        this.id = id;
